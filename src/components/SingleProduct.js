        ...
        <MDBContainer fluid className="my-5">
          <MDBRow>
            <MDBCol md="12" lg="12" className="mb-4 mb-lg-0">
              <MDBCard style={{ direction: "rtl",position:"relative"}} class="card-container">
                ...
                <div className="d-flex justify-content-between p-3" id="card-title" >
                  <p className="lead mb-0" id="cardTitle">{product.product_name}</p>
                  <div
                ...
                <MDBCardBody>
                  <div className="d-flex justify-content-between" id="companyPrice">
                        <p className="small">
                  ...
                  <div className="d-flex justify-content-between mb-3" id="companyPrice">
                    <h5 className="mb-0">{product.sub_category}</h5>
                    <h5 className="text-dark mb-0" style={{marginBottom:"50px"}}>{productPrice}$</h5>
                  </div>
